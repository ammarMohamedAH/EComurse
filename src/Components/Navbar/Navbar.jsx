  ...
  return (
    <nav className="fixed-top bg-[#f8f9fa] border-gray-200 dark:bg-gray-900 sticky top-0 z-50">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        {/* Mobile Menu */}
        <div
          className={`w-full lg:w-3/4 ${isMenuOpen ? "block" : "hidden"} lg:flex lg:justify-end`}
          id="navbar-default"
        >
            ...
            {isLogin ? (
              <div className="flex lg:flex-row flex-col align-middle gap-6 justify-evenly w-full">
                <div className="lg:flex gap-6 ml-20">
                  ...
                  <li><NavLink to="/categories" className="block text-gray-600 py-2 px-3 hover:text-gray-800">Categories</NavLink></li>
